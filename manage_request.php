...
<div class="container-fluid">
	<form action="" id="manage-request">
		...
		<div class="form-group">
			<label for="" class="control-label">Nombre completo del paciente</label>
			<input type="text" class="form-control" name="patient"  value="<?php echo isset($patient) ? $patient :'' ?>" required>
		</div>
		<div class="form-group">
	        <label for="" class="control-label">Grupo Sanguíneo</label>
		...
		<div class="form-group">
			...
			<select name="status" id="" class="custom-select select2" required>
				...
				<option value="1" <?php echo $status == 1 ? 'selected' : ''  ?>>Aprobado</option>
			</select>
		</div>
	<?php endif; ?>
</div>
