...
<div class="container-fluid">
	<form action="" id="manage-donation">
		...
		<div class="form-group">
			<label for="" class="control-label">Nombre del donante</label>
...
<script>
	$('.select2').select2({
		placeholder:'Porfavor, seleccione un donante aquí.',
		width:'100%'
	})
